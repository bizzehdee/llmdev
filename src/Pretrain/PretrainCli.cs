...
public static class PretrainCli
{
    public static int Run(string[] args, TextWriter stdout, TextWriter stderr)
    {
        if (args.Length < 3)
        {
            ...
            stdout.WriteLine();
            stdout.WriteLine("--resume-from-checkpoint <path> loads an existing checkpoint and");
            ...
            stdout.WriteLine();
            stdout.WriteLine("--gpu selects the ILGPU-backed matmul path and requires a genuine");
            ...
            stdout.WriteLine();
            stdout.WriteLine("--gpu-resident-weights (requires --gpu) keeps every model parameter");
            ...
            stdout.WriteLine("device-resident kernels too, but measured slower than the");
